...
export default function StaffResetPassword() {
  ...
  const onSubmit = async (e) => {
    ...
    setBusy(true);
    try {
      await api("/staff/reset-password", { method: "POST", body: { token, newPassword: password } });
      navigate("/admin/login", { replace: true, state: { resetSuccess: true } });
    } catch (err) {
    ...
    <div className="auth-page">
      <div className="auth-card-wrap">
        <div className="auth-card">
          ...
          <p className="auth-lead">Choose a strong password for your staff account.</p>
          <form onSubmit={onSubmit} noValidate>
            <label className="auth-label auth-label--first" htmlFor="staff-reset-password">
              New password
            </label>
            ...
            <label className="auth-label" htmlFor="staff-reset-confirm">
